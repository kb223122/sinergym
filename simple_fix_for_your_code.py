...
Just change 'config_params' to 'extra_config' in your original code.
"""
...
# ✅ FIXED: Use 'extra_config' instead of 'config_params'
extra_config = {
...
# ✅ FIXED: Custom reward function parameters
reward_kwargs = {
...
# ✅ FIXED: Create environment with correct parameter name
env = gym.make('Eplus-5zone-hot-continuous-v1', 
               extra_config=extra_config,  # ← Changed from config_params
